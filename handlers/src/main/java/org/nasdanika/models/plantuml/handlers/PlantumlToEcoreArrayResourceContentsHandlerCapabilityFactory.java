...
public class PlantumlToEcoreArrayResourceContentsHandlerCapabilityFactory extends ServiceCapabilityFactory<org.nasdanika.capability.emf.ResourceContentsHandler.Requirement, ResourceContentsHandler<EObject[]>> {
	...
	protected ResourceContentsHandler<EObject[]> createHandler(Resource resource, ResourceContentsHandler<Document> dh) {
		return new PlantumlToEcoreResourceContentsHandler(resource, dh).adaptToEObjectArrayContentsHandler();
	}
