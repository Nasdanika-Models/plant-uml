 ...
 */
public class PlantumlResourceContentsHandlerCapabilityFactory extends ServiceCapabilityFactory<org.nasdanika.capability.emf.ResourceContentsHandler.Requirement, ResourceContentsHandler<Document>> {
	...
	protected CompletionStage<Iterable<CapabilityProvider<ResourceContentsHandler<Document>>>> createService(
		...
		return wrap(new PlantumlResourceContentsHandler());
	}
